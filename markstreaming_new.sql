...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2022 at 09:46 AM
...
CREATE TABLE `admincontacts` (
  ...
  `send_status` tinyint(2) NOT NULL DEFAULT 0 COMMENT '0-> not sent, 1-> sent, 2-> blocked',
  `unsubscribe` enum('YES','NO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NO',
  `invalid` enum('YES','NO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NO',
  `response` enum('YES','NO') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'NO',
...
--
-- Table structure for table `admin_usertemplates`
--

CREATE TABLE `admin_usertemplates` (
  `id` bigint(20) UNSIGNED NOT NULL,
...
CREATE TABLE `banners` (
  ...
  `attached_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_description` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_button` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
...
CREATE TABLE `buckets` (
  ...
  `bucket_path` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `access_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `secret_key` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `has_common` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `buckets` (`id`, `name`, `region`, `bucket_path`, `access_key`, `secret_key`, `has_common`, `created_at`, `updated_at`) VALUES
(1, 'orocaststudio', 'ap-south-1', 'https://orocaststudio.s3.ap-south-1.amazonaws.com/', 'AKIAR3MTNOKJKVQJIZW7', 'Y1VECpTE9UgGQkoZE6E+0iZK0EIgt2dVGtOKlvuP', '1', NULL, NULL);
...
CREATE TABLE `contents` (
  ...
  `has_youtube_trailer` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_youtube_video` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `has_free_content` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_cast` enum('1','0') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `has_comment` enum('1','0') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '1',
  `trailer_encoding` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_encoding` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `ppv` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0-> for no ppv for this content. others are payperview id',
...
INSERT INTO `contents` (`id`, `store_id`, `content_type`, `parent_content_id`, `season_id`, `uniq_id`, `name`, `slug`, `description`, `poster`, `poster_path`, `trailer`, `trailer_url`, `video`, `video_url`, `has_youtube_trailer`, `has_youtube_video`, `youtube_trailer`, `cast`, `genre`, `seo_title`, `seo_description`, `category`, `release_type`, `release_date`, `has_free_content`, `has_cast`, `has_comment`, `trailer_encoding`, `video_encoding`, `ppv`, `publish`, `created_at`, `updated_at`) VALUES
(113, 1, 'singlepart', NULL, NULL, 'bd6e75ddfc6dff517d7fae770d2c70d6', 'edeed', 'edeed', '<p>bhjub</p>', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', 'edeed', 'edeed', '', 'immediate', '2022-06-30 05:30:56', '1', '1', '1', NULL, NULL, 0, '0', '2022-06-30 00:00:56', '2022-06-30 00:00:56');
...
INSERT INTO `content_categories` (`id`, `store_id`, `uniq_id`, `name`, `slug`, `description`, `image`, `attached_url`, `created_at`, `updated_at`) VALUES
(20, 1, '51b8ad9e939c9e36cb6054aa8eee0743', 'dcdre', 'dcdre', 'bjhbhb', NULL, NULL, '2022-06-30 00:02:03', '2022-06-30 00:02:03');
...
CREATE TABLE `coupons` (
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `discount_type` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `coupon_amount` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `coupon_exp_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `default_pages` (`id`, `name`, `slug`, `created_at`, `updated_at`) VALUES
(1, 'Cast', 'cast', NULL, NULL),
(2, 'Genres', 'genres', NULL, NULL),
(3, 'Post Category', 'post-category', NULL, NULL),
(4, 'Content Category', 'content-category', NULL, NULL),
(5, 'Auction Category', 'auction-category', NULL, NULL),
(6, 'Product Category', 'product-category', NULL, NULL),
(7, 'All Contents', 'all-contents', NULL, NULL),
(8, 'Auctions', 'auctions', NULL, NULL),
(9, 'Shop', 'shop', NULL, NULL),
(10, 'All Contents', 'all-contents', NULL, NULL),
(11, 'Cast', 'cast', NULL, NULL),
(12, 'Genres', 'genres', NULL, NULL),
(13, 'Post Category', 'post-category', NULL, NULL),
(14, 'Content Category', 'content-category', NULL, NULL),
(15, 'Auction Category', 'auction-category', NULL, NULL),
(16, 'Product Category', 'product-category', NULL, NULL),
(17, 'Auctions', 'auctions', NULL, NULL),
(18, 'Shop', 'shop', NULL, NULL);
...
CREATE TABLE `featured_sections` (
  ...
  `section_type` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `my_plans` (
  ...
  `store_plan_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `start_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `end_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `next_bill_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `pages` (
  ...
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `publish` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `pages` (`id`, `store_id`, `uniqid`, `title`, `slug`, `content`, `meta_title`, `meta_description`, `layout`, `image`, `publish`, `created_at`, `updated_at`) VALUES
(14, 1, 'fe33d1d9d44769ca7f35e402f374b095', 'ujnujn', 'ujnujn', '<p>nnju</p>', 'ujnuju', 'ujnujnu', 'pricing', NULL, '0', '2022-06-30 00:04:21', '2022-06-30 00:04:21');
...
CREATE TABLE `payment_gateways` (
  ...
  `key1` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `key5` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `key6` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `payperviews`
--
...
CREATE TABLE `permissions` (
  `id` int(10) UNSIGNED NOT NULL,
  `permission_model` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `players` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `store_id` bigint(20) DEFAULT NULL,
  `relatedMenu` tinyint(4) NOT NULL DEFAULT 1,
  `shareMenu` tinyint(4) NOT NULL DEFAULT 1,
  `rateMenu` tinyint(4) NOT NULL DEFAULT 1,
  `zoomMenu` tinyint(4) NOT NULL DEFAULT 1,
  `mirrorButton` tinyint(4) NOT NULL DEFAULT 0,
  `resume` tinyint(4) NOT NULL DEFAULT 0,
  `theaterButton` tinyint(4) NOT NULL DEFAULT 1,
  `qualityButton` tinyint(4) NOT NULL DEFAULT 1,
  `endAction` tinyint(4) NOT NULL DEFAULT 0,
  `endActionData` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `timetooltip` tinyint(4) NOT NULL DEFAULT 0,
  `mousedisplay` tinyint(4) NOT NULL DEFAULT 0,
  `videoInfo` tinyint(4) NOT NULL DEFAULT 1,
  `skin` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `showlogo` tinyint(4) NOT NULL DEFAULT 1,
  `logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logocontrolbar` tinyint(4) NOT NULL DEFAULT 0,
  `logoposition` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `players` (`id`, `store_id`, `relatedMenu`, `shareMenu`, `rateMenu`, `zoomMenu`, `mirrorButton`, `resume`, `theaterButton`, `qualityButton`, `endAction`, `endActionData`, `timetooltip`, `mousedisplay`, `videoInfo`, `skin`, `showlogo`, `logo`, `logocontrolbar`, `logoposition`, `created_at`, `updated_at`) VALUES
(1, 8, 1, 1, 1, 1, 0, 0, 1, 1, 0, NULL, 0, 0, 1, NULL, 1, NULL, 0, NULL, NULL, NULL),
(2, 131, 1, 1, 1, 1, 0, 0, 1, 1, 0, 'related', 0, 0, 1, 'default', 0, NULL, 0, 'LT', NULL, '2022-06-13 10:09:15');
...
CREATE TABLE `posts` (
  ...
  `slug` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_excerpt` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `image` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `post_category_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meta_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `posts` (`id`, `store_id`, `title`, `slug`, `content`, `page_excerpt`, `image`, `post_category_id`, `meta_title`, `meta_description`, `created_at`, `updated_at`) VALUES
(7, 1, 'dfe', 'dfe', NULL, NULL, NULL, '', 'dfe', 'dfe', '2022-06-30 00:11:01', '2022-06-30 00:11:01');
...
INSERT INTO `post_categories` (`id`, `store_id`, `name`, `slug`, `description`, `image`, `created_at`, `updated_at`) VALUES
(5, 1, 'manager', 'manager', 'fvfd', NULL, '2022-06-30 00:11:18', '2022-06-30 00:11:18');
...
INSERT INTO `roles` (`id`, `store_id`, `title`, `name`, `guard_name`, `created_at`, `updated_at`) VALUES
(57, 149, 'Admin', 'lll_store', 'store', '2022-06-29 19:41:36', '2022-06-29 19:41:36'),
(58, 151, 'Admin', 'rrr_store', 'store', '2022-06-29 19:42:49', '2022-06-29 19:42:49'),
(59, 153, 'Admin', 'admin_store', 'store', '2022-06-29 19:44:43', '2022-06-29 19:44:43'),
(60, 154, 'Admin', 'kkk_store', 'store', '2022-06-29 19:52:56', '2022-06-29 19:52:56'),
(61, 156, 'Admin', 'kkk_store', 'store', '2022-06-29 19:53:47', '2022-06-29 19:53:47'),
(62, 158, 'Admin', 'kkk_store', 'store', '2022-06-29 19:54:40', '2022-06-29 19:54:40'),
(63, 159, 'Admin', 'ppp_store', 'store', '2022-06-29 19:57:40', '2022-06-29 19:57:40'),
(64, 160, 'Admin', 'mm_store', 'store', '2022-06-29 20:21:09', '2022-06-29 20:21:09'),
(65, 161, 'Admin', 'nnn_store', 'store', '2022-06-29 20:29:08', '2022-06-29 20:29:08'),
(66, 162, 'Admin', 'hhh_store', 'store', '2022-06-29 20:34:49', '2022-06-29 20:34:49'),
(67, 163, 'Admin', 'huuhub_store', 'store', '2022-06-29 20:48:52', '2022-06-29 20:48:52'),
(68, 164, 'Admin', 'tttt_store', 'store', '2022-06-29 20:53:54', '2022-06-29 20:53:54'),
(69, 165, 'Admin', 'hghghg_store', 'store', '2022-06-29 20:57:28', '2022-06-29 20:57:28'),
(70, 166, 'Admin', 'ddd_store', 'store', '2022-06-29 21:00:28', '2022-06-29 21:00:28'),
(71, 168, 'Admin', 'eee_store', 'store', '2022-06-29 21:04:06', '2022-06-29 21:04:06'),
(72, 169, 'Admin', 'qqq_store', 'store', '2022-06-29 21:06:50', '2022-06-29 21:06:50'),
(73, 1, 'Admin', 'test_company_store', 'store', '2022-06-29 23:38:46', '2022-06-29 23:38:46'),
(74, 2, 'Admin', 'test1_store', 'store', '2022-06-29 23:40:37', '2022-06-29 23:40:37'),
(75, 3, 'Admin', 'test2_store', 'store', '2022-06-29 23:45:54', '2022-06-29 23:45:54'),
(76, 4, 'Admin', 'hhh_store', 'store', '2022-06-30 01:52:08', '2022-06-30 01:52:08'),
(77, 5, 'Admin', 'aaa_store', 'store', '2022-06-30 02:13:52', '2022-06-30 02:13:52');
...
CREATE TABLE `stores` (
  ...
  `s3bucket_id` int(11) DEFAULT NULL,
  `plan_id` int(11) DEFAULT NULL,
  `has_subscribed` int(11) DEFAULT NULL,
  `is_live` int(11) DEFAULT NULL,
  `email_verified` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `email_otp` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_active` tinyint(2) NOT NULL DEFAULT 0,
  `signup_steps` int(11) DEFAULT NULL,
  `has_approved` enum('0','1') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  `type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `stores` (`id`, `uniqid`, `name`, `company_name`, `email`, `password`, `remember_token`, `domain`, `slug`, `theme`, `s3bucket_id`, `plan_id`, `has_subscribed`, `is_live`, `email_verified`, `email_otp`, `has_active`, `signup_steps`, `has_approved`, `type`, `parent_id`, `created_at`, `updated_at`) VALUES
(1, '165656572662bd2fdea8069', 'test', 'test company', 'test@gmail.com', '$2y$10$UTgATw4kZKP6cuKCxovxwe7pSnsetlOFTAaeGpXwJNLKG1Nj/M8LS', NULL, NULL, 'test_company', 'revo', 1, NULL, 0, 0, '0', '9MT1C8KJ', 1, 1, '0', 'Superuser', NULL, '2022-06-29 23:38:46', '2022-06-29 23:38:46'),
(2, '165656583762bd304db02f9', 'test1', 'test1', 'test1@gmail.com', '$2y$10$vuffwPhiNDGMEKYmFg8TFuPe57nLPc1RZ.pCE0P0/Wbi0NH2WqEP.', NULL, NULL, 'test1', 'revo', 1, NULL, 0, 0, '0', '5J1Y8SZ0', 1, 1, '0', 'Superuser', NULL, '2022-06-29 23:40:37', '2022-06-29 23:40:37'),
(3, '165656615462bd318a88e86', 'test2', 'test2', 'test2@gmail.com', '$2y$10$6aQAa6nLRaM0GbXbRGbkjuDRpoILN1UDFKJax7rhmeLBOTYUCk206', NULL, NULL, 'test2', 'revo', 1, NULL, 0, 0, '0', 'WPWGLDD0', 1, 1, '0', 'Superuser', NULL, '2022-06-29 23:45:54', '2022-06-29 23:45:54'),
(4, '165657372862bd4f2083984', 'hhh', 'hhh', 'hhh@hhh.hhh', '$2y$10$Tj.xCSQ/W8GX0sXGENLUzulVKnbPQYuSJtKna0BxH1okCcsym9bgi', NULL, NULL, 'hhh', 'revo', 1, NULL, 0, 0, '0', '8F6ZHKTO', 1, 1, '0', 'Superuser', NULL, '2022-06-30 01:52:08', '2022-06-30 01:52:08'),
(5, '165657503262bd5438a5d47', 'aaa', 'aaa', 'aaa@gmail.com', '$2y$10$B8CmjiwGzCuB2iopTVVW6./4OMQ9guiRnsbwAKX7im3AJneNfGG7G', NULL, NULL, 'aaa', 'revo', 1, NULL, 0, 0, '0', 'XGSGWHL2', 1, 1, '0', 'Superuser', NULL, '2022-06-30 02:13:52', '2022-06-30 02:13:52');

-- --------------------------------------------------------

--
-- Table structure for table `store_apps`
--
...
--
-- Dumping data for table `store_apps`
--

INSERT INTO `store_apps` (`id`, `store_id`, `app_id`, `name`, `created_at`, `updated_at`) VALUES
(109, 159, '1', '', '2022-06-29 20:12:49', '2022-06-29 20:12:49');
...
--
-- Table structure for table `store_password_resets`
--
...
CREATE TABLE `store_payments` (
  ...
  `uniqid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `store_id` int(11) DEFAULT NULL,
  `store_plan_id` int(11) DEFAULT NULL,
  `card_id` int(11) DEFAULT NULL,
  `charged_amount` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `paid_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('PAID','NOT PAID') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `store_plans` (
  ...
  `description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `price` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `three_month` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `six_month` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twelve_month` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `twentyfour_month` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `store_signups`
--

CREATE TABLE `store_signups` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `uniqid` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `email` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `domain` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `theme` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `signup_step` enum('1','2','3') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_live` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `country` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_active` enum('0','1') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `store_themes` (
  ...
  `main_banner_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `inner_page_banner_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_banner_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_poster_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `episode_poster_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `content_category_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cast_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `genre_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `media_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `page_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `post_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `postpagecategory_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_category_image_size` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `subscription_plans` (
  ...
  `price` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `duration` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `has_freetrial` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0-> No, 1-> Yes',
  `freetrialdays` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0-> In Active, 1-> Active',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `templates` (
  ...
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `type` enum('default','custom') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `theme_properties`
--

CREATE TABLE `theme_properties` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `store_id` int(11) DEFAULT NULL,
  `header_tagline` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `header_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `footer_logo` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_seo_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_seo_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_og_title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `default_og_description` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `theme_properties`
--

INSERT INTO `theme_properties` (`id`, `store_id`, `header_tagline`, `header_logo`, `footer_logo`, `default_seo_title`, `default_seo_description`, `default_og_title`, `default_og_description`, `og_image`, `analytics`, `custom_css`, `menu`, `created_at`, `updated_at`) VALUES
(53, 151, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-06-29 19:42:49', '2022-06-29 19:42:49');
...
(2, '12:15 AM', NULL, NULL),
(3, '12:30 AM', NULL, NULL),
(4, '12:45 AM', NULL, NULL),
(5, '1:00 AM', NULL, NULL),
(6, '1:15 AM', NULL, NULL),
(7, '1:30 AM', NULL, NULL),
(8, '1:45 AM', NULL, NULL),
(9, '2:00 AM', NULL, NULL),
(10, '2:15 AM', NULL, NULL),
(11, '2:30 AM', NULL, NULL),
(12, '2:45 AM', NULL, NULL),
(13, '3:00 AM', NULL, NULL),
(14, '3:15 AM', NULL, NULL),
(15, '3:30 AM', NULL, NULL),
(16, '3:45 AM', NULL, NULL),
(17, '4:00 AM', NULL, NULL),
(18, '4:15 AM', NULL, NULL),
(19, '4:30 AM', NULL, NULL),
(20, '4:45 AM', NULL, NULL),
(21, '5:00 AM', NULL, NULL),
(22, '5:15 AM', NULL, NULL),
(23, '5:30 AM', NULL, NULL),
(24, '5:45 AM', NULL, NULL),
(25, '6:00 AM', NULL, NULL),
(26, '6:15 AM', NULL, NULL),
(27, '6:30 AM', NULL, NULL),
(28, '6:45 AM', NULL, NULL),
(29, '7:00 AM', NULL, NULL),
(30, '7:15 AM', NULL, NULL),
(31, '7:30 AM', NULL, NULL),
(32, '7:45 AM', NULL, NULL),
(33, '8:00 AM', NULL, NULL),
(34, '8:15 AM', NULL, NULL),
(35, '8:30 AM', NULL, NULL),
(36, '8:45 AM', NULL, NULL),
(37, '9:00 AM', NULL, NULL),
(38, '9:15 AM', NULL, NULL),
(39, '9:30 AM', NULL, NULL),
(40, '9:45 AM', NULL, NULL),
(41, '10:00 AM', NULL, NULL),
(42, '10:15 AM', NULL, NULL),
(43, '10:30 AM', NULL, NULL),
(44, '10:45 AM', NULL, NULL),
(45, '11:00 AM', NULL, NULL),
(46, '11:15 AM', NULL, NULL),
(47, '11:30 AM', NULL, NULL),
(48, '11:45 AM', NULL, NULL),
(49, '12:00 PM', NULL, NULL),
(50, '12:15 PM', NULL, NULL),
(51, '12:30 PM', NULL, NULL),
(52, '12:45 PM', NULL, NULL),
(53, '1:00 PM', NULL, NULL),
(54, '1:15 PM', NULL, NULL),
(55, '1:30 PM', NULL, NULL),
(56, '1:45 PM', NULL, NULL),
(57, '2:00 PM', NULL, NULL),
(58, '2:15 PM', NULL, NULL),
(59, '2:30 PM', NULL, NULL),
(60, '2:45 PM', NULL, NULL),
(61, '3:00 PM', NULL, NULL),
(62, '3:15 PM', NULL, NULL),
(63, '3:30 PM', NULL, NULL),
(64, '3:45 PM', NULL, NULL),
(65, '4:00 PM', NULL, NULL),
(66, '4:15 PM', NULL, NULL),
(67, '4:30 PM', NULL, NULL),
(68, '4:45 PM', NULL, NULL),
(69, '5:00 PM', NULL, NULL),
(70, '5:15 PM', NULL, NULL),
(71, '5:30 PM', NULL, NULL),
(72, '5:45 PM', NULL, NULL),
(73, '6:00 PM', NULL, NULL),
(74, '6:15 PM', NULL, NULL),
(75, '6:30 PM', NULL, NULL),
(76, '6:45 PM', NULL, NULL),
(77, '7:00 PM', NULL, NULL),
(78, '7:15 PM', NULL, NULL),
(79, '7:30 PM', NULL, NULL),
(80, '7:45 PM', NULL, NULL),
(81, '8:00 PM', NULL, NULL),
(82, '8:15 PM', NULL, NULL),
(83, '8:30 PM', NULL, NULL),
(84, '8:45 PM', NULL, NULL),
(85, '9:00 PM', NULL, NULL),
(86, '9:15 PM', NULL, NULL),
(87, '9:30 PM', NULL, NULL),
(88, '9:45 PM', NULL, NULL),
(89, '10:00 PM', NULL, NULL),
(90, '10:15 PM', NULL, NULL),
(91, '10:30 PM', NULL, NULL),
(92, '10:45 PM', NULL, NULL),
(93, '11:00 PM', NULL, NULL),
(94, '11:15 PM', NULL, NULL),
(95, '11:30 PM', NULL, NULL),
(96, '11:45 PM', NULL, NULL);
...
CREATE TABLE `time_zones` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `utc` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `utc_time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `time_zones` (`id`, `utc`, `utc_time`, `timezone`, `created_at`, `updated_at`) VALUES
(1, '-12:00', 'UTC-12:00', 'International Date Line West', NULL, NULL),
(2, '-11:00', 'UTC-11:00', 'Coordinated Universal Time-11', NULL, NULL),
(3, '-10:00', 'UTC-10:00', 'Aleutain Island', NULL, NULL),
(4, '-10:00', 'UTC-10:00', 'Hawaii', NULL, NULL),
(5, '-09:30', 'UTC-09:30', 'Alaska', NULL, NULL),
(6, '-09:00', 'UTC-09:00', 'Coordinated Universal Time-09', NULL, NULL),
(7, '-08:00', 'UTC-08:00', 'Baja California', NULL, NULL),
(8, '-08:00', 'UTC-08:00', 'Coordinated Universal Time-08', NULL, NULL),
(9, '-08:00', 'UTC-08:00', 'Pacific Time(US & Canada)', NULL, NULL),
(10, '-07:00', 'UTC-07:00', 'Arizona', NULL, NULL),
(11, '-07:00', 'UTC-07:00', 'Chihuahua', NULL, NULL),
(12, '-07:00', 'UTC-07:00', 'Aleutain Island, La Paz and Mazatlan', NULL, NULL),
(13, '-07:00', 'UTC-07:00', 'Mountain Time(US & Canada)', NULL, NULL),
(14, '-07:00', 'UTC-07:00', 'Yukon', NULL, NULL),
(15, '-06:00', 'UTC-06:00', 'Central America', NULL, NULL),
(16, '-06:00', 'UTC-06:00', 'Easter Island', NULL, NULL),
(17, '-06:00', 'UTC-06:00', 'Guadalajara, Mexico city, Monterrey', NULL, NULL),
(18, '-06:00', 'UTC-06:00', 'Saskatchewan', NULL, NULL),
(19, '-05:00', 'UTC-05:00', 'Chetumal', NULL, NULL),
(20, '-05:00', 'UTC-05:00', 'Eastern Time(US & Canada)', NULL, NULL),
(21, '-05:00', 'UTC-05:00', 'Haiti', NULL, NULL),
(22, '-05:00', 'UTC-05:00', 'Havana', NULL, NULL),
(23, '-05:00', 'UTC-05:00', 'Indiana (East)', NULL, NULL),
(24, '-04:00', 'UTC-04:00', 'Asuncion', NULL, NULL),
(25, '-04:00', 'UTC-04:00', 'Atlantic Time (Canada)', NULL, NULL),
(26, '-04:00', 'UTC-04:00', 'Caracas', NULL, NULL),
(27, '-04:00', 'UTC-04:00', 'Cuiaba', NULL, NULL),
(28, '-04:00', 'UTC-04:00', 'Georgetown, La Paz, Manaus, San Juan', NULL, NULL),
(29, '-04:00', 'UTC-04:00', 'Santiago', NULL, NULL),
(30, '-03:30', 'UTC-03:30', ' Newfoundland', NULL, NULL),
(31, '-03:00', 'UTC-03:00', 'Araguaina', NULL, NULL),
(32, '-03:00', 'UTC-03:00', 'Brasilia', NULL, NULL),
(33, '-03:00', 'UTC-03:00', 'Cayenne, Fortaleza', NULL, NULL),
(34, '-03:00', 'UTC-03:00', 'City of Buenos Aires', NULL, NULL),
(35, '-03:00', 'UTC-03:00', 'Greenland', NULL, NULL),
(36, '-03:00', 'UTC-03:00', 'Montivideo', NULL, NULL),
(37, '-03:00', 'UTC-03:00', 'Punta Arenas', NULL, NULL),
(38, '-03:00', 'UTC-03:00', 'Saint Pierre and Miquelon', NULL, NULL),
(39, '-03:00', 'UTC-03:00', 'Salvador', NULL, NULL),
(40, '-02:00', 'UTC-02:00', 'Coordinated Universal Time-02', NULL, NULL),
(41, '-01:00', 'UTC-01:00', 'Cabo Verde Is', NULL, NULL),
(42, '+00:00', 'UTC+00:00', 'Dublin, Edinburgh, Lisbon, London', NULL, NULL),
(43, '+00:00', 'UTC+00:00', 'Monrovia, Reykjavik', NULL, NULL),
(44, '+00:00', 'UTC+00:00', 'Sao Tome', NULL, NULL),
(45, '+01:00', 'UTC+01:00', 'Casablance', NULL, NULL),
(46, '+01:00', 'UTC+01:00', 'Amstradam, Berlin, Bern, Rome, Stockholm, Vienna', NULL, NULL),
(47, '+01:00', 'UTC+01:00', 'Belgrade, Bratislave, Budapest, Ljubljana, Prague', NULL, NULL),
(48, '+01:00', 'UTC+01:00', 'Brussels, Copenhagen, Madrid, Paris', NULL, NULL),
(49, '+01:00', 'UTC+01:00', 'Sarajevo, Skopje, Warsaw, Zagreb', NULL, NULL),
(50, '+01:00', 'UTC+01:00', 'West crentral Africa', NULL, NULL),
(51, '+02:00', 'UTC+02:00', 'Amman', NULL, NULL),
(52, '+02:00', 'UTC+02:00', 'Athens, Bucharest', NULL, NULL),
(53, '+02:00', 'UTC+02:00', 'Beitur', NULL, NULL),
(54, '+02:00', 'UTC+02:00', 'Cairo', NULL, NULL),
(55, '+02:00', 'UTC+02:00', 'Chisinau', NULL, NULL),
(56, '+02:00', 'UTC+02:00', 'Damascus', NULL, NULL),
(57, '+02:00', 'UTC+02:00', 'Gaza, Hebron', NULL, NULL),
(58, '+02:00', 'UTC+02:00', 'Harare, Pretoria', NULL, NULL),
(59, '+02:00', 'UTC+02:00', 'Helsinki, kyiv, Riga, Sofia, Tallinn, Vilnius', NULL, NULL),
(60, '+02:00', 'UTC+02:00', 'Jerusalem', NULL, NULL),
(61, '+02:00', 'UTC+02:00', 'Kaliningrad', NULL, NULL),
(62, '+02:00', 'UTC+02:00', 'Khartoum', NULL, NULL),
(63, '+02:00', 'UTC+02:00', 'Tripoli', NULL, NULL),
(64, '+02:00', 'UTC+02:00', 'Windhoik', NULL, NULL),
(65, '+03:00', 'UTC+03:00', 'Baghdad', NULL, NULL),
(66, '+03:00', 'UTC+03:00', 'Istanbul', NULL, NULL),
(67, '+03:00', 'UTC+03:00', 'Kuwait, Riyadh', NULL, NULL),
(68, '+03:00', 'UTC+03:00', 'Minsk', NULL, NULL),
(69, '+03:00', 'UTC+03:00', 'Mascow, St. Petersburg', NULL, NULL),
(70, '+03:00', 'UTC+03:00', 'Nairobi', NULL, NULL),
(71, '+03:30', 'UTC+03:30', 'Tehran', NULL, NULL),
(72, '+04:00', 'UTC+04:00', 'Abu Dhabi, Muscat', NULL, NULL),
(73, '+04:00', 'UTC+04:00', 'Astrakhan, Ulyanovsk', NULL, NULL),
(74, '+04:00', 'UTC+04:00', 'Baku', NULL, NULL),
(75, '+04:00', 'UTC+04:00', 'Izhevsk, Samara', NULL, NULL),
(76, '+04:00', 'UTC+04:00', 'Port, Louis', NULL, NULL),
(77, '+04:00', 'UTC+04:00', 'Saratov', NULL, NULL),
(78, '+04:00', 'UTC+04:00', 'Tbilisi', NULL, NULL),
(79, '+04:00', 'UTC+04:00', 'Volgograd', NULL, NULL),
(80, '+04:00', 'UTC+04:00', 'Yerevan', NULL, NULL),
(81, '+04:30', 'UTC+04:30', 'Kabul', NULL, NULL),
(82, '+05:00', 'UTC+05:00', 'Ashgabat, Tashkent', NULL, NULL),
(83, '+05:00', 'UTC+05:00', 'Ekaterinburg', NULL, NULL),
(84, '+05:00', 'UTC+05:00', 'Islamabad, Karachi', NULL, NULL),
(85, '+05:00', 'UTC+05:00', 'Qyxylorda', NULL, NULL),
(86, '+05:30', 'UTC+05:30', 'New Delhi, Chennai, Kolkata, Mumbai', NULL, NULL),
(87, '+05:30', 'UTC+05:30', 'Sri Jayawardenepura', NULL, NULL),
(88, '+05:45', 'UTC+05:45', 'Kathmandu', NULL, NULL),
(89, '+06:00', 'UTC+06:00', 'Astana', NULL, NULL),
(90, '+06:00', 'UTC+06:00', 'Dhaka', NULL, NULL),
(91, '+06:00', 'UTC+06:00', 'Omsk', NULL, NULL),
(92, '+06:30', 'UTC+06:30', 'Yangon(Rangoon)', NULL, NULL),
(93, '+07:00', 'UTC+07:00', 'Bangkok, Hanoi, Jakarta', NULL, NULL),
(94, '+07:00', 'UTC+07:00', 'Barnaul, Gorno-Altaysk', NULL, NULL),
(95, '+07:00', 'UTC+07:00', 'Hovd', NULL, NULL),
(96, '+07:00', 'UTC+07:00', 'Krasnoyarsk', NULL, NULL),
(97, '+07:00', 'UTC+07:00', 'Novosibirsk', NULL, NULL),
(98, '+07:00', 'UTC+07:00', 'Tomsk', NULL, NULL),
(99, '+08:00', 'UTC+08:00', 'Beijing, Chongqing, Hong Kong, Urumqi', NULL, NULL),
(100, '+08:00', 'UTC+08:00', 'Irkutsk', NULL, NULL),
(101, '+08:00', 'UTC+08:00', 'Kuala Lumpur, singapur', NULL, NULL),
(102, '+08:00', 'UTC+08:00', 'Perth', NULL, NULL),
(103, '+08:00', 'UTC+08:00', 'Taipei', NULL, NULL),
(104, '+08:00', 'UTC+08:00', 'Ullanbaatar', NULL, NULL),
(105, '+08:45', 'UTC+08:45', 'Eucla', NULL, NULL),
(106, '+09:00', 'UTC+09:00', 'Chita', NULL, NULL),
(107, '+09:00', 'UTC+09:00', 'Osaka, Sapporo, Tokyo', NULL, NULL),
(108, '+09:00', 'UTC+09:00', 'Pyongyang', NULL, NULL),
(109, '+09:00', 'UTC+09:00', 'Seoul', NULL, NULL),
(110, '+09:00', 'UTC+09:00', 'Yakutsk', NULL, NULL),
(111, '+09:30', 'UTC+09:30', 'Adelaide', NULL, NULL),
(112, '+09:30', 'UTC+09:30', 'Darwin', NULL, NULL),
(113, '+10:00', 'UTC+10:00', 'Brisbane', NULL, NULL),
(114, '+10:00', 'UTC+10:00', 'Canberra, Melbourne, Sydney', NULL, NULL),
(115, '+10:00', 'UTC+10:00', 'Guam, Port Moresby', NULL, NULL),
(116, '+10:00', 'UTC+10:00', 'Hobart', NULL, NULL),
(117, '+10:00', 'UTC+10:00', 'Vladivostok', NULL, NULL),
(118, '+10:30', 'UTC+10:30', 'Lord Howe Island', NULL, NULL),
(119, '+11:00', 'UTC+11:00', 'Bougainville Island', NULL, NULL),
(120, '+11:00', 'UTC+11:00', 'Chokurdakh', NULL, NULL),
(121, '+11:00', 'UTC+11:00', 'Magadan', NULL, NULL),
(122, '+11:00', 'UTC+11:00', 'Norfolk Island', NULL, NULL),
(123, '+11:00', 'UTC+11:00', 'Sakhalin', NULL, NULL),
(124, '+11:00', 'UTC+11:00', 'Solomon Is., New Caledonia', NULL, NULL),
(125, '+12:00', 'UTC+12:00', 'Anadyr, Petropavlovsk-kamchatsky', NULL, NULL),
(126, '+12:00', 'UTC+12:00', 'Auckland, Wellington', NULL, NULL),
(127, '+12:00', 'UTC+12:00', 'Coordinated Universal Time+12', NULL, NULL),
(128, '+12:00', 'UTC+12:00', 'Fiji', NULL, NULL),
(129, '+12:45', 'UTC+12:45', 'Chatham Island', NULL, NULL),
(130, '+13:00', 'UTC+13:00', 'Coordinated Universal Time+13', NULL, NULL),
(131, '+13:00', 'UTC+13:00', 'Nuku alofa', NULL, NULL),
(132, '+13:00', 'UTC+13:00', 'Samoa', NULL, NULL),
(133, '+14:00', 'UTC+14:00', 'Kritimati Island', NULL, NULL);
...
CREATE TABLE `user_cards` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` bigint(20) DEFAULT NULL,
  `user_type` enum('AUCTIONEER','BIDDER','USER') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `short_card` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `user_subscriptions` (
  ...
  `start_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `end_date` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_by` enum('STARTED','CHARGED') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Indexes for table `admin_usertemplates`
--
ALTER TABLE `admin_usertemplates`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `content_banners`
--
...
--
-- Indexes for table `content_seasons`
--
...
--
-- Indexes for table `featured_contents`
--
...
--
-- Indexes for table `payperviews`
--
ALTER TABLE `payperviews`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `store_password_resets`
--
ALTER TABLE `store_password_resets`
  ADD KEY `store_password_resets_email_index` (`email`),
  ADD KEY `store_password_resets_token_index` (`token`);
...
--
-- Indexes for table `store_plans`
--
ALTER TABLE `store_plans`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `store_signups`
--
ALTER TABLE `store_signups`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `theme_properties`
--
ALTER TABLE `theme_properties`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `admincontacts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36059;
...
--
-- AUTO_INCREMENT for table `admin_usertemplates`
--
ALTER TABLE `admin_usertemplates`
...
--
-- AUTO_INCREMENT for table `content_banners`
--
ALTER TABLE `content_banners`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=106;
...
--
-- AUTO_INCREMENT for table `content_seasons`
--
ALTER TABLE `content_seasons`
...
--
-- AUTO_INCREMENT for table `featured_contents`
--
ALTER TABLE `featured_contents`
...
--
-- AUTO_INCREMENT for table `payperviews`
--
ALTER TABLE `payperviews`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `store_apps`
--
ALTER TABLE `store_apps`
...
--
-- AUTO_INCREMENT for table `store_plans`
--
ALTER TABLE `store_plans`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `store_signups`
--
ALTER TABLE `store_signups`
...
--
-- AUTO_INCREMENT for table `theme_properties`
--
ALTER TABLE `theme_properties`
